    ...
    <div>
      ...
      <form>
        <div className="form-group">
          <label className="form-check-label" for="exampleInputEmail1">Weight (lbs)</label>
        ...
        <div className="form-group">
          ...
          <div className="form-group">
            <div className="form-check form-check-inline">
              ...
              <label className="form-check-label" for="inlineCheckbox1">M</label>
            </div>
          </div>
        </div>
        ...
        <div className="form-check form-check-inline">
          ...
          <label className="form-check-label" for="inlineCheckbox2">F</label>
        </div>

        <div className="form-group">
          <label className="form-check-label" for="inputPhoneNumber">Phone Number</label>
          <input type="email" className="form-control" id="inputPhoneNumber" aria-describedby="emailHelp" placeholder="2522551122"></input>
        </div>

        <div className="form-group">
          <label className="form-check-label" for="emergencyContactPhoneNumber">Emergency Contact Phone Number</label>
