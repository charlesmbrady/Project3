...
class Home extends Component {
  ...
  sendText = () => {
    ...
    const theMessageString = `sms:${this.state.emergencyContactNumber}&body=` + encodeURIComponent("Come meet me out on the town! This link was generated by sipSpot: " + theUrl);
