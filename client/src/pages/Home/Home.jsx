...
class Home extends Component {
  ...
  sendText = () => {
    ...
    const theUserPhoneNumber = this.state.userPhoneNumber;
    const theMessageString = "sms:" + theUserPhoneNumber + "&body=" + encodeURIComponent("Come meet me out on the town! This link was generated by sipSpot: " + theUrl);
    alert(theMessageString);
    window.open(theMessageString, "_self");
    // window.open("sms:" + theUserPhoneNumber + "&body=" + encodeURIComponent("Come meet me out on the town! This link was generated by sipSpot: " + theUrl), "_self");
    return false;
  }
